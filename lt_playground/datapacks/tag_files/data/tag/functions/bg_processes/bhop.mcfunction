...
execute as @a[scores={jump=1..}] as @s[scores={jump.bhop2=20..49}, tag = !tagger, tag = !afk, tag = !safezoned, gamemode = adventure] at @s if entity @a[tag = tagger, tag = !afk, tag = !safezoned, gamemode = adventure] if block ~ ~2 ~ air run scoreboard players set @s playtime.title.trigger 2
execute as @a[scores={jump=1..}] as @s[scores={jump.bhop2=20..}, tag = !tagger, tag = !afk, tag = !safezoned, gamemode = adventure] at @s if entity @a[tag = tagger, tag = !afk, tag = !safezoned, gamemode = adventure] if block ~ ~2 ~ air run scoreboard players add @s playtime 1
execute as @a[scores={jump=1..}] as @s[scores={jump.bhop2=50..74}, tag = !tagger, tag = !afk, tag = !safezoned, gamemode = adventure] at @s if entity @a[tag = tagger, tag = !afk, tag = !safezoned, gamemode = adventure] if block ~ ~2 ~ air run scoreboard players set @s playtime.title.trigger 3
execute as @a[scores={jump=1..}] as @s[scores={jump.bhop2=50..}, tag = !tagger, tag = !afk, tag = !safezoned, gamemode = adventure] at @s if entity @a[tag = tagger, tag = !afk, tag = !safezoned, gamemode = adventure] if block ~ ~2 ~ air run scoreboard players add @s playtime 1
execute as @a[scores={jump=1..}] as @s[scores={jump.bhop2=75..}, tag = !tagger, tag = !afk, tag = !safezoned, gamemode = adventure] at @s if entity @a[tag = tagger, tag = !afk, tag = !safezoned, gamemode = adventure] if block ~ ~2 ~ air run scoreboard players set @s playtime.title.trigger 4
execute as @a[scores={jump=1..}] as @s[scores={jump.bhop2=75..}, tag = !tagger, tag = !afk, tag = !safezoned, gamemode = adventure] at @s if entity @a[tag = tagger, tag = !afk, tag = !safezoned, gamemode = adventure] if block ~ ~2 ~ air run scoreboard players add @s playtime 1
...
execute as @a[scores={jump=1..}] as @s[scores={jump.bhop2=20..}, tag = !tagger, tag = !afk, tag = !safezoned, gamemode = adventure] at @s if entity @a[tag = tagger, tag = !afk, tag = !safezoned, gamemode = adventure] if block ~ ~2 ~ air run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ .25 2
