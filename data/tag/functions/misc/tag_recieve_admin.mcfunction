...
execute unless entity @s[tag=invincible, tag=!afk] run tellraw @a[team = !menu_tagger, team = !menu] [{"text":"🔥 ","color":"light_purple"},{"selector":"@s","color":"gold","bold":true},{"translate":"tag.chat.admin","color":"aqua"}]
