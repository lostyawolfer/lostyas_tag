...
execute unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run title @a[team = !menu_tagger, team = !menu, tag=tag.give_out] title [{"selector":"@s","color":"#FFFF00","bold":true},{"translate":"tag.infect.title.new_tagged","color":"gold","bold":false}]
execute unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run title @s[team = !menu_tagger, team = !menu] title [{"translate":"tag.infect.title.you_tagged","color":"red","bold":true}]
...
execute as @a[tag=tag.give_out] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible] run title @a[team = !menu_tagger, team = !menu] subtitle [{"translate":"tag.infect.subtitle.tag_by1","color":"#00AAAA"},{"selector":"@s","color":"#00FFFF","bold":true},{"translate":"tag.infect.subtitle.tag_by2"}]
execute as @a[tag=tag.give_out] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible] run title @s[team = !menu_tagger, team = !menu] subtitle [{"translate":"tag.infect.subtitle.tag_by1","color":"#00AA00"},{"translate":"tag.infect.subtitle.you","color":"#00FF00","bold":true},{"translate":"tag.infect.subtitle.tag_by2"}]
...
execute as @a[tag=tag.give_out] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible] run tellraw @a[team = !menu_tagger, team = !menu] [{"text":"🔥 ","color":"gold"},{"selector":"@s","color":"aqua","bold":false},{"translate":"tag.infect.chat","color":"aqua"},{"text":"","color":"yellow"},{"selector":"@a[tag=tag.recieve]","color":"gold","bold":true}]
