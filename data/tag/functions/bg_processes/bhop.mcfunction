...
# remove bhop
execute as @a[scores={jump.timer=1..}, nbt={OnGround: 1b}] at @s run scoreboard players remove @s jump.timer 6
execute as @a[scores={jump.timer=1..}] as @s[scores={stat.speed2=0}, nbt={OnGround: 1b}] at @s run scoreboard players remove @s jump.timer 20
