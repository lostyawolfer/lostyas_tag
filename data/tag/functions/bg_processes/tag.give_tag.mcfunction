...
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run particle block gold_block ~ ~1 ~ .3 .6 .3 0 50
execute as @a[tag=tag.recieve] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible, tag=!afk] run title @a[team = !menu_tagger, team = !menu] subtitle [{"translate":"tag.admin1","color":"#00AAAA"},{"translate":"tag.admin2","color":"#00FFFF","bold":true}]
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run title @a[team = !menu_tagger, team = !menu] title [{"selector":"@s","color":"#FFFF00","bold":true},{"translate":"tag.title.new_tagged","color":"gold","bold":false}]
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run title @s[team = !menu_tagger, team = !menu] title [{"translate":"tag.title.you_tagged","color":"red","bold":true}]
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run damage @s 1
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run title @a[tag = !menu_tagger, tag = !menu] times 0 20 3
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run title @s times 0 30 50
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run playsound minecraft:entity.elder_guardian.curse player @s ~ ~ ~ 5
#execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run function run_song:play
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run scoreboard players add @s stat.get_tagged 1
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run scoreboard players set @s playtime.title.trigger -4
#execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run playsound minecraft:entity.experience_orb.pickup player @s ~ ~ ~ 1 1.5
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run scoreboard players set @s playtime 0
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run scoreboard players set @s[scores={playtime=..-1}] playtime 0
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run function tag:tag_lightning
execute as @a[tag=tag.recieve] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run tag @s add tagger
#  Giver
...
execute as @a[tag=tag.give_out] at @s unless entity @a[tag=tag.recieve.mantled] unless entity @a[tag=invincible] run tellraw @a[team = !menu_tagger, team = !menu] [{"text":"🔥 ","color":"gold"},{"selector":"@s","color":"aqua","bold":false},{"translate":"tag.chat","color":"dark_aqua"},{"text":"🗡","color":"yellow"},{"selector":"@a[tag=tag.recieve]","color":"gold","bold":true}]
...
#execute as @a[tag=tag.give_out] at @s unless entity @s[tag=tag.recieve.mantled] unless entity @s[tag=invincible, tag=!afk] run function run_song:stop
