...
#  Set team
team join a.tagger @a[team = !a.tagger, tag = !safezoned, tag = tagger, gamemode = adventure]
...
#  Cosmetics
execute as @a[tag=tagger, gamemode = adventure] at @s run particle dust 1 .5 0 1 ~ ~2 ~ 5 5 5 0 1 normal @s
execute as @a[tag=tagger, gamemode = adventure] at @s run item replace entity @s armor.head with carved_pumpkin
execute as @a[tag=!safezoned, tag=tagger, gamemode=adventure] unless score @s nbs_runsong matches 0.. run function run_song:play
...
#  Set team (spectator)
team join z.spectator @a[team = !z.spectator, tag = !tagger, gamemode=spectator]
team join z.spectator.tagger @a[team = !z.spectator.tagger, tag = tagger, gamemode=spectator]
