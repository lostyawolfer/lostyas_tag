...
execute if score @s menu matches 100 if score @s menu.selecting matches 7 if score @s menu.trigger matches 1.. run function tag:items/menu/selector_check {product: ab, id: 7, price: 17, page: 110}
...
execute if score @s menu matches 110 run function tag:items/menu/items/product {product: ab, slot: 6, id: 7, price: 17, price_count: many, page: 110, command: 100}
