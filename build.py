...
def build_respack(respack_url,
    ...
    zip_folder(respack_dir, zip_fpath.parent, zip_fpath.name, compression_ratio=0)

    build_respack_config(zip_fpath, respack_url=respack_url,
                         respack_prompt=respack_prompt, tpl_file=tpl_file)
