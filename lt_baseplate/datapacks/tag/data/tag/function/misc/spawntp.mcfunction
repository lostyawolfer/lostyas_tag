...
execute at @s if entity @e[type=armor_stand, tag=spawn, sort=random, limit=1, distance=10..] run tp @s @e[type=armor_stand, tag=spawn, sort=random, limit=1, distance=10..]
execute at @s unless entity @e[type=armor_stand, tag=spawn, sort=random, limit=1, distance=10..] run tp @s @e[type=armor_stand, tag=spawn, sort=random, limit=1, distance=0..]