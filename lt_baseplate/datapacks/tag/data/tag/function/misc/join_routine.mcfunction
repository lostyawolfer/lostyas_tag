...
execute unless score @s anim.death matches 1.. unless score @s effect.downed matches 1.. unless score @s effect.freeze matches 1.. run scoreboard players set @s[tag=!special] anim.death -14
