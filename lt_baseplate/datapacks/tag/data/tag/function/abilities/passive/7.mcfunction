execute as @s[tag=!safezoned, gamemode=adventure] if score @s pa.active matches 1.. if score @s pa.ability_specific.jump matches 1.. unless score @s effect.invisibility matches 1.. run playsound block.sculk.fall player @a ~ ~ ~ 2
execute as @s[tag=!safezoned, gamemode=adventure] if score @s pa.active matches 1.. if score @s pa.ability_specific.jump matches 1.. unless score @s effect.invisibility matches 1.. run particle sculk_charge{roll:0} ~ ~-.2 ~ .25 .1 .25 0 15
...
execute as @s[tag=!safezoned, gamemode=adventure] if block ~ ~ ~ #slabs unless block ~1 ~1 ~ #tag:non_jumpable_blocks if block ~1 ~2 ~ air run effect give @s jump_boost infinite 0 true
execute as @s[tag=!safezoned, gamemode=adventure] if block ~ ~ ~ #slabs unless block ~-1 ~1 ~ #tag:non_jumpable_blocks if block ~-1 ~2 ~ air run effect give @s jump_boost infinite 0 true
