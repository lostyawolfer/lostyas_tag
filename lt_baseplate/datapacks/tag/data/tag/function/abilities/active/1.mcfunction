...
execute as @s[scores={ab.use.trigger=1..}] unless score @s pa.current_passive matches 5 run scoreboard players set @s effect.strong_levitation 8
execute as @s[scores={ab.use.trigger=1..}] if score @s pa.current_passive matches 5 run scoreboard players set @s effect.strong_levitation 13
