...
execute as @s[tag=temp2] run scoreboard players set @s ab.cd 200
execute as @s[scores={ab.use2=1..}] unless score @s ab.cd matches 1400 run scoreboard players add @s ab.cd 1
