...
execute as @s[scores={ab.use.trigger=1..}] unless score @s pa.current matches 5 run scoreboard players set @s ab.use 10
execute as @s[scores={ab.use.trigger=1..}] if score @s pa.current matches 5 run scoreboard players set @s ab.use 15
...
execute as @s[scores={stat.flew_in_ability=200..}] unless score @s pa.current matches 5 run scoreboard players set @s ab.use -1
execute as @s[scores={stat.flew_in_ability=500..}] if score @s pa.current matches 5 run scoreboard players set @s ab.use -1
