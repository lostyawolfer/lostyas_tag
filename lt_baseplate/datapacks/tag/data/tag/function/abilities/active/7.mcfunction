...
execute as @s[scores={stat.flew_in_ability=500..}] unless score @s pa.current matches 5 run scoreboard players set @s ab.use -1
execute as @s[scores={stat.flew_in_ability=1000..}] if score @s pa.current matches 5 run scoreboard players set @s ab.use -1
...
execute as @s[scores={ab.use=-1}] run tp @s @s
