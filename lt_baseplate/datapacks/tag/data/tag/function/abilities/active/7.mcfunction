...
execute as @s[scores={ab.use.trigger=1..}] run scoreboard players set @s ab.use 7
...
execute as @s[scores={stat.flew_in_ability=200..}] run scoreboard players set @s ab.use -1
