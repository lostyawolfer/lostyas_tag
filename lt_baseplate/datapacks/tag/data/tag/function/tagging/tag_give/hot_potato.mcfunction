...
title @a[tag = hit_detect.giver] title [{"selector": "@a[tag = hit_detect.taker]", "color": "#FFFF00", "bold": true}, {"translate": "title.hit.hot_potato_other", "color":"gold"}]
title @a[tag = hit_detect.giver] subtitle [{"translate": "subtitle.hit.hot_potato_you_1", "color":"dark_green"}, {"translate": "subtitle.hit.hot_potato_you", "color":"green", "bold": true}, {"translate": "subtitle.hit.hot_potato_you_2", "color":"dark_green"}]
