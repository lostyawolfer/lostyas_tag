...
title @a[tag = hit_detect.giver] subtitle [{"translate": "subtitle.hit.default_you_1", "color":"dark_green"}, " ", {"translate": "subtitle.hit.you", "color":"green", "bold": true}, " ", {"translate": "subtitle.hit.default_you_2", "color":"dark_green"}]

title @a[tag = hit_detect.taker] title [{"translate": "title.hit.default_you", "color":"red", "bold": true}]
title @a[tag = hit_detect.taker] subtitle [{"translate": "subtitle.hit.default_other_1", "color":"dark_aqua"}, " ", {"selector": "@a[tag = hit_detect.giver]", "color":"aqua", "bold": true}, " ", {"translate": "title.hit.default_other_2", "color":"dark_aqua"}]
