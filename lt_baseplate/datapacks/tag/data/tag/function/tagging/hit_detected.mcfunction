...
execute if score game server matches 1 if entity @a[tag = hit_detect.giver, tag = tagger] if entity @a[tag = hit_detect.taker, tag =!tagger] run function tag:tagging/tag.default
execute if score game server matches 2 if entity @a[tag = hit_detect.giver, tag = tagger] if entity @a[tag = hit_detect.taker, tag =!tagger] run function tag:tagging/tag.infection
execute if score game server matches 3 if entity @a[tag = hit_detect.giver, tag = tagger] if entity @a[tag = hit_detect.taker, tag =!tagger] run function tag:tagging/tag.murder
execute if score game server matches 4 if entity @a[tag = hit_detect.giver, tag =!tagger] if entity @a[tag = hit_detect.taker, tag = tagger] run function tag:tagging/tag.crown
execute if score game server matches 5 if entity @a[tag = hit_detect.giver, tag = tagger] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!special] run function tag:tagging/tag.freeze
execute if score game server matches 5 if entity @a[tag = hit_detect.giver, tag =!tagger, tag =!special] if entity @a[tag = hit_detect.taker, tag = special] run function tag:tagging/tag.unfreeze
