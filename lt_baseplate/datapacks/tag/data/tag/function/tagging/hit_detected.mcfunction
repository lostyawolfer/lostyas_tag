...
execute if score game server matches 0 if entity @a[tag = hit_detect.giver,               tag =!safezone, tag =!invincible_one_time] if entity @a[tag = hit_detect.taker,               tag =!safezone] run function tag:tagging/tag_give/default_start
execute if score game server matches 0 if entity @a[tag = hit_detect.giver,               tag =!safezone, tag = invincible_one_time] if entity @a[tag = hit_detect.taker,               tag =!safezone] run function tag:tagging/tag_give/absorbed
execute if score game server matches 1 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag =!invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!safezone] run function tag:tagging/tag_give/default
execute if score game server matches 1 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag = invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!safezone] run function tag:tagging/tag_give/absorbed
execute if score game server matches 2 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag =!invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!safezone] run function tag:tagging/tag_give/infection
execute if score game server matches 2 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag = invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!safezone] run function tag:tagging/tag_give/absorbed
execute if score game server matches 3 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag =!invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!safezone] run function tag:tagging/tag_give/murder
execute if score game server matches 3 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag = invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!safezone] run function tag:tagging/tag_give/absorbed
execute if score game server matches 4 if entity @a[tag = hit_detect.giver, tag =!tagger, tag =!safezone, tag =!invincible_one_time] if entity @a[tag = hit_detect.taker, tag = tagger, tag =!safezone] run function tag:tagging/tag_give/crown
execute if score game server matches 4 if entity @a[tag = hit_detect.giver, tag =!tagger, tag =!safezone, tag = invincible_one_time] if entity @a[tag = hit_detect.taker, tag = tagger, tag =!safezone] run function tag:tagging/tag_give/absorbed
execute if score game server matches 5 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag =!invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!special, tag =!safezone] run function tag:tagging/tag_give/freeze
execute if score game server matches 5 if entity @a[tag = hit_detect.giver, tag = tagger, tag =!safezone, tag = invincible_one_time] if entity @a[tag = hit_detect.taker, tag =!tagger, tag =!special, tag =!safezone] run function tag:tagging/tag_give/absorbed
