...
title @a[tag = hit_detect.giver] subtitle [{"translate": "subtitle.hit.crown_you", "color":"green", "bold": true}, {"translate": "subtitle.hit.crown_you_1", "color":"dark_green", "bold": false}, {"selector": "@a[tag = hit_detect.giver]", "color":"aqua", "bold": true}, {"translate": "subtitle.hit.crown_you_2", "color":"dark_green"}]

title @a[tag = hit_detect.taker] title [{"selector": "@a[tag = hit_detect.taker]", "color": "red", "bold": true}, {"translate": "title.hit.crown_other", "bold": false, "color": "dark_red"}]
