...
title @a[tag = hit_detect.taker] subtitle [{"translate": "subtitle.hit.infect_other_1", "color":"dark_aqua"}, {"selector": "@a[tag = hit_detect.giver]", "color":"aqua", "bold": true}, {"translate": "title.hit.infect_other_2", "color":"dark_aqua"}]
