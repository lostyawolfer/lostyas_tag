...
execute if score @s menu matches 2.. run item replace entity @s container.7 with air
execute if score @s menu matches 2.. run item replace entity @s container.8 with minecraft:warped_fungus_on_a_stick[custom_data={game:4, menu:1}, custom_model_data=3, custom_name='[{"translate":"menu.back","color":"red","italic":false}]']

execute if score @s menu matches 1 run item replace entity @s container.0 with minecraft:warped_fungus_on_a_stick[custom_data={game:4, menu:110}, custom_model_data=4, custom_name='[{"translate":"menu.ab","color":"yellow","italic":false}]']
execute if score @s menu matches 1 run item replace entity @s container.1 with minecraft:warped_fungus_on_a_stick[custom_data={game:4, menu:210}, custom_model_data=11, custom_name='[{"translate":"menu.pa","color":"gold","italic":false}]']
execute if score @s menu matches 1 run item replace entity @s container.2 with minecraft:warped_fungus_on_a_stick[custom_data={game:4, menu:310}, custom_model_data=18, custom_name='[{"translate":"menu.gh","color":"gray","italic":false}]']
