...
execute if score @s menu.trigger matches 1.. run clear @s *[!custom_data={menu:0}, !custom_data={menu:1}, !custom_data={game:0}]

execute if score @s menu matches 110..119 run function tag:items/menu/abilities/page1
