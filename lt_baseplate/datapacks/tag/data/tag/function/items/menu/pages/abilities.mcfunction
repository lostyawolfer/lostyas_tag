...
execute if score @s menu.selecting matches 4 if score @s menu.trigger matches 1.. run function tag:items/menu/show_info {product: ab, id: 4, cd: 36, cd_format: sec, cd_count: many, use: 05, use_format: sec, use_count: many}
...
execute if score @s menu.selecting matches 8 if score @s menu.trigger matches 1.. run function tag:items/menu/show_info {product: ab, id: 8, cd: 65, cd_format: sec, cd_count: many, use: 90, use_format: sec, use_count: many}
execute if score @s menu.selecting matches 9 if score @s menu.trigger matches 1.. run function tag:items/menu/show_info {product: ab, id: 9, cd: 70, cd_format: sec, cd_count: many, use: 03, use_format: sec, use_count: two}