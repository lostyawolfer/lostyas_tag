...
execute if score @s menu matches 200 if score @s menu.selecting matches 6 if score @s menu.trigger matches 1.. run function tag:items/menu/selector_check {product: pa, id: 6, price: 15, page: 220}
...
execute if score @s menu matches 220 run function tag:items/menu/items/product {product: pa, slot: 1, id: 6, price: 15, price_count: many, page: 220, command: 200}
execute if score @s menu matches 220 run function tag:items/menu/items/product {product: pa, slot: 2, id: 7, price: 25, price_count: many, page: 220, command: 200}
execute if score @s menu matches 220 run function tag:items/menu/items/product {product: pa, slot: 3, id: 8, price: 20, price_count: many, page: 220, command: 200}
