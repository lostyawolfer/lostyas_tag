...
execute if score @s gh.current_goat_horn matches 1 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "ponder_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
execute if score @s gh.current_goat_horn matches 2 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "sing_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
execute if score @s gh.current_goat_horn matches 3 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "seek_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
execute if score @s gh.current_goat_horn matches 4 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "feel_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
execute if score @s gh.current_goat_horn matches 5 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "admire_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
execute if score @s gh.current_goat_horn matches 6 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "call_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
execute if score @s gh.current_goat_horn matches 7 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "yearn_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
execute if score @s gh.current_goat_horn matches 8 unless score @s gh.cd matches -4.. run item replace entity @s container.7 with goat_horn[instrument = "dream_goat_horn", custom_name='{"translate": "item.minecraft.goat_horn", "italic": false, "color": "#B7B77F", "bold": true}', custom_data={game: 1}]
...
execute if score @s gh.cd matches -1 at @s run playsound minecraft:item.goat_horn.sound.1 master @s ~ ~ ~ .2 2
execute if score @s gh.cd matches -1 at @s run playsound minecraft:block.amethyst_block.break master @s ~ ~ ~ .2 2
execute if score @s gh.cd matches -4 at @s run stopsound @s master minecraft:item.goat_horn.sound.1
