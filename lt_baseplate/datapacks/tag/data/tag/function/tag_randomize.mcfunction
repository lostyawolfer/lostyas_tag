execute unless score tag.random_counter server matches 0.. run tellraw @a [{"text":"🔥 ","color":"light_purple"},{"translate":"tag.chat.choosing_random","color":"dark_aqua"}]
...
execute if score tag.random_counter server matches 25..29 if score tag.random_counter.time server matches 1.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r","color":"aqua"},{"text":" <"}]
...
execute if score tag.random_counter server matches 18..24 if score tag.random_counter.time server matches 3.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r","color":"green"},{"text":" <"}]
...
execute if score tag.random_counter server matches 14..17 if score tag.random_counter.time server matches 5.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r","color":"yellow"},{"text":" <"}]
...
execute if score tag.random_counter server matches 11..13 if score tag.random_counter.time server matches 8.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r","color":"gold"},{"text":" <"}]
...
execute if score tag.random_counter server matches 4..10 if score tag.random_counter.time server matches 10.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r","color":"red"},{"text":" <"}]
...
execute if score tag.random_counter server matches 1..3 if score tag.random_counter.time server matches 15.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r","color":"dark_red"},{"text":" <"}]
