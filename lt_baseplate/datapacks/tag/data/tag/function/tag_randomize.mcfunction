...
execute if score tag.random_counter server matches 25..29 if score tag.random_counter.time server matches 1.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"blue"},{"text":" <"}]
...
execute if score tag.random_counter server matches 18..24 if score tag.random_counter.time server matches 3.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"blue"},{"text":" <"}]
...
execute if score tag.random_counter server matches 14..17 if score tag.random_counter.time server matches 5.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"blue"},{"text":" <"}]
...
execute if score tag.random_counter server matches 11..13 if score tag.random_counter.time server matches 8.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"blue"},{"text":" <"}]
...
execute if score tag.random_counter server matches 7..10 if score tag.random_counter.time server matches 10.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"blue"},{"text":" <"}]
execute if score tag.random_counter server matches 6 if score tag.random_counter.time server matches 10.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"aqua"},{"text":" <"}]
execute if score tag.random_counter server matches 5 if score tag.random_counter.time server matches 10.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"green"},{"text":" <"}]
execute if score tag.random_counter server matches 4 if score tag.random_counter.time server matches 10.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"yellow"},{"text":" <"}]
...
execute if score tag.random_counter server matches 3 if score tag.random_counter.time server matches 15.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"gold"},{"text":" <"}]
execute if score tag.random_counter server matches 2 if score tag.random_counter.time server matches 15.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"red"},{"text":" <"}]
execute if score tag.random_counter server matches 1 if score tag.random_counter.time server matches 15.. run title @a title [{"text":"> ","bold": true, "color": "yellow"},{"selector":"@r[tag=!prev_tagger]","color":"dark_red"},{"text":" <"}]
