...
execute if score tag.random_counter server matches 0 if score tag.random_counter.time server matches 20.. unless score game server matches 7 if score game server matches 2.. unless score game server matches 4 run scoreboard players set kill_timer server 6000
